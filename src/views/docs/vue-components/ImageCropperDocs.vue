<template>
    <div class="container narrow pt-3">
        <h1 class="heading text-center">Image Cropper</h1>
        <p class="body font-light mb-3 text-center">A custom image cropper extending and combining the Cropperjs and Dropzone libraries.</p>
        ...
        <div class="flex flex-column bg-white shadow corners-3 pa mv-4">
            ...
            <table class="body">
                ...
                <tr class="bg-light">
                    ...
                    <td class="pa-1">The brand string, affects the color theme of the component</td>
                </tr>
                <tr class="bg-light">
        ...
        <div class="flex flex-column bg-white shadow corners-3 pa mv-4">
            ...
            <table class="body">
                ...
                <tr class="bg-light">
                    <td class="pa-1 font-bold">imageSaved</td>
                    <td class="pa-1">Fired when the image is finished uploading to s3 and hits the saveEndpoint</td>
                </tr>
            </table>
        </div>
        ...
        <div class="flex flex-column bg-white shadow corners-3 pa mb-4">
            ...
            <v-embed id="imageCropperJs" class="mb-3">
                https://gist.github.com/CurtisConway/e7dadf6dee3ccc0a05548a6ecde1f61e.js
            </v-embed>
        </div>
    </div>
</template>
