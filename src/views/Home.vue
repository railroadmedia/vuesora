<template>
    <div class="container narrow pt-3">
        ...
        <p class="body font-light mb-5 text-center">
            Vuesora is a CSS and Vue Component Library built for use within the Musora member's areas.
        </p>

        <div class="flex flex-column pa mb-4">
            <h1 class="title text-secondary mb">
                Local Development Environment
            </h1>

            <p class="body mb-3">
                The interactions between all of the packages that make up the Musora stack can be quite daunting. The commands below should be able to fix most common issues than can occur.
            </p>

            <h1 class="title text-secondary mb-1">
                Compiling Assets
            </h1>

            <p class="body mb-1">
                Applications use the Laravel Mix wrapper for webpack to compile/transpile all assets in a project, they use the default npm scripts that come installed with Laravel
            </p>
            ...
            <p class="body mb-1">
                If you are trying to build out views for an application and you get a laravel error saying a bladesora view cannot be found, you likely don't have the most recent version installed. Since that version changes constantly, for local development it's best to set up a symbolic link between the projects.
            </p>
        ...
        <div class="flex flex-column pa mb-4">
            ...
            <p class="body mb-3">
                Publishing vuesora is fairly simple: update the version, push the repo, publish the package, and update your applications package.json.
            </p>
