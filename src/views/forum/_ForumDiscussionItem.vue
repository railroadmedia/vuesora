<template>
    <a
        :href="discussion.url"
        class="tw-relative tw-flex tw-flex-row tw-p-4 tw-pl-0 tw-text-black tw-no-underline tw-border-0 tw-border-b tw-border-solid tw-border-gray-200 hover:tw-bg-red-50"
    >
        <!-- Avatar -->
        ...
        <div class="tw-flex tw-flex-col tw-justify-center">
            ...
            <p class="tw-text-sm tw-text-gray-500 tw-max-w-lg tw-truncate">{{ discussion.description }}</p>
        </div>
