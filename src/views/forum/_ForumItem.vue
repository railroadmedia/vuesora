<template>
    ...
    >
        ...
        <div class="tw-grid tw-grid-cols-8 tw-grid-rows-2 tw-w-full tw-min-w-0 tw-pr-0"
             :class="[ (forum.description)? 'tw-grid-flow-col': 'tw-grid-flow-row' ]">
             <!-- Title -->
            <h4 class="tw-leading-6 tw-col-span-6 sm:tw-col-span-7 lg:tw-col-span-6 xl:tw-col-span-7 tw-text-lg tw-font-bold tw-inline-flex tw-items-start md:tw-items-center tw-row-span-1 "
                :class="{ 'tw-row-span-2': !forum.description }">{{ forum.title }}</h4>
            
            <!-- Description -->
            <p v-if="forum.description" class=" tw-col-span-8 sm:tw-col-span-7 lg:tw-col-span-6 xl:tw-col-span-7 md:tw-pr-4 tw-text-13">
                {{ forum.description }}
            </p>

            <!-- Reply Amount -->
            <div class="tw-text-gray-600 tw-text-left tw-pl-0 sm:tw-px-4 tw-col-span-2 sm:tw-col-span-1 lg:tw-col-span-2 lg:tw-pl-10 xl:tw-pl-4 xl:tw-col-span-1 md:tw-row-span-2 tw-inline-flex tw-mt-1 tw-items-start md:tw-items-center"
