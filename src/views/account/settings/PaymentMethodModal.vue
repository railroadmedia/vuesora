    ...
    <div>
        ...
        >
            <div class="flex flex-column bg-white corners-3 shadow">
                ...
                <div
                    v-if="isCreditCardMethod || editing"
                    class="credit-card-fields"
                >
                    <div
                        v-if="isCreditCardMethod"
                        class="flex flex-row ph-3"
                    >
                        <div class="flex flex-column mb-1">
                            <div class="form-group">
                                <input
                    ...
                    <div class="flex flex-row ph-3 inline-inputs">
                        ...
                        <div
                            v-if="isCreditCardMethod"
                            class="flex flex-column smaller"
                        >
                            <div class="form-group">
                                <input
                                    id="cvvNumber"
                    ...
                    <div
                        class="flex flex-row ph-3"
                        :class="{'inline-inputs': showRegion}"
                    >
                        <div class="flex flex-column">
                            <div class="form-group">
                                <select
...
export default {
    ...
    methods: {
        init() {
            ...
            for (const prop in this.formFields) {
        ...
        save() {
            ...
            if (this.validForm) {
                ...
                if (this.isCreditCardMethod) {
                    ...
                    const tokenObject = this.getStripeTokenPayload();
        ...
        handleStripeResponse(status, response) {
            ...
            if (response.error) {
                ...
                const payload = this.getNewCardPaymentMethodPayload(response.id);
        ...
        handleStripeError(error) {
            if (error && error.code && this.stripeErrorsMap[error.code]) {
                const fieldName = this.stripeErrorsMap[error.code].field;
                const errorMessage = this.stripeErrorsMap[error.code].message || error.message;
        ...
        showGenericError() {
            const message = 'An error has been reported by our payment processor, please try again. '
        ...
        handleCreatePaymentMethodResponse(response) {
            ...
            if (response.meta && response.meta.errors) {
                if (response.meta.errors.detail
                    ...
                    // other type of error
                    const message = `${'[PaymentMethodModal Component]::handleCreatePaymentMethodResponse '
        ...
        validateCardRegion() {
            if (this.cardCountry.toLowerCase() == 'canada' && !this.cardRegion) {
                ...
                const hadError = this.formFields.cardRegion.hasError;
        ...
        validateField(fieldName, fieldValueValidationCallback) {
            ...
            if (
                ...
                const hadError = this.formFields[fieldName].hasError;
