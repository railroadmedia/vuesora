...
do
    case $opt in
        "drumeo")
            ...
            npm run lib:watch & npm link; cd /app/drumeo/laravel; npm link vuesora; npm run watch;
            echo "Watching Drumeo For Changes..."
            ;;
        "pianote")
            echo "Symlinking Vuesora with Pianote!"
            npm run lib:watch & npm link; cd /app/pianote; npm link vuesora; npm run watch;
            echo "Watching Pianote For Changes..."
            ;;
        "guitareo")
            echo "Symlinking Vuesora with Guitareo!"
            npm run lib:watch & npm link; cd /app/guitareo; npm link vuesora; npm run watch;
            ;;
        *)
